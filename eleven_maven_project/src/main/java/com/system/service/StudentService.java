...
public interface StudentService {
    ...
    //一对多查询，查询该学生的选题信息
    StudentCustom findStudentAndSelectTopicListByName(String name) throws Exception;

    //指定stu_id联表查询到学生的详细信息和学院信息
    StudentCustom findStudentAndCollegeById(Integer stuId) throws Exception;

    List<Integer> findAllStuId() throws Exception;
}
