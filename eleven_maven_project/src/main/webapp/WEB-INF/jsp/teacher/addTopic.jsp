        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" action="/teacher/addTopic" id="editfrom" method="post">
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">课题号</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="inputEmail3" name="topicId" placeholder="请输入课题号">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-2 control-label">课题名称</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputPassword3" name="topicTitle" placeholder="请输入课题名称">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="topicType" placeholder="请输入课题类型">
                            </div>
                        </div>
                        <%--<div class="form-group">--%>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="topicRequest" placeholder="请输入课题要求">
                            </div>
                        </div>
                        <%--<div class="form-group">--%>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="topicContent" placeholder="请输入课题简介">
                            </div>
                        </div>
